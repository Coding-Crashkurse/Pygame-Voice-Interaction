...
from constants import SCREEN_HEIGHT, SCREEN_WIDTH, SCENE_CITY, SCENE_START
...
class GameOverScene(BaseScene):
    def __init__(self, app: "GameApp") -> None:
        ...
        self.retry_button = Button(pygame.Rect(SCREEN_WIDTH // 2 - 120, SCREEN_HEIGHT // 2 + 60, 240, 60), "Retry", self.body_font, self._retry)
    ...
    def render(self, surface: pygame.Surface) -> None:
        ...
        subtitle = self.body_font.render("Your journey ends here...", True, pygame.Color("white"))
        surface.blit(subtitle, subtitle.get_rect(center=(SCREEN_WIDTH // 2, SCREEN_HEIGHT // 2)))
